...
export async function POST(req: Request) {
  ...
  // 上传图片模式：先从图片本身提取主体和配色，再用当前文化配置约束再创作方向。
  ...
  const promptText = isUpload
    ? [
        ...
        "如果画面中有多个对象，优先选择面积更大、边界更完整、对比度更高且位于视觉中心的对象作为主体。",
        "去除杂乱背景、环境干扰和多余物体，保留主体的关键外轮廓和内部识别特征。",
        "",
        "第二步 - 分析颜色组成：",
        "分析该主体元素所使用的颜色组成，按可见面积估算主色、辅助色和点缀色的大致占比。",
        "记录下该主体的核心配色方案（包含 2~6 种主要颜色），背景色不计入主体配色。",
        "",
        "第三步 - 串联文化意象并按配色比例再创作：",
        "以提取出的主体为基础，结合上方文化主题、目标核心元素、文化说明和作品形式重新设计文创图案。",
        ...
        "可以围绕主体元素融入中国传统纹样来增强文化感，但颜色体系必须保持与原主体一致，且主体应占据画面主要面积。",
        "",
        "技术要求：",
